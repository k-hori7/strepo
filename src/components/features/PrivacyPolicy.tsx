    ...
    <article className={`bg-white ${className ?? ""}`}>
      <div className="max-w-[768px] mx-auto px-6 pt-16 pb-32 md:pt-24 md:pb-24">
        ...
        <div className="flex flex-col gap-12">
          ...
          {/* Article 1 */}
          <section>
            <SectionHeading>第1条（基本方針）</SectionHeading>
          ...
          {/* Article 2 */}
          <section>
            <SectionHeading>第2条（収集する情報および収集方法）</SectionHeading>
          ...
          {/* Article 3 */}
          <section>
            <SectionHeading>第3条（個人情報の利用目的）</SectionHeading>
          ...
          {/* Article 4 */}
          <section>
            <SectionHeading>第4条（名簿レス設計とデータ保護）</SectionHeading>
            <p className="text-base font-light text-slate-600 leading-relaxed">
          ...
          {/* Article 5 */}
          <section>
            <SectionHeading>第5条（データの保存期間）</SectionHeading>
            <p className="text-base font-light text-slate-600 leading-relaxed">
          ...
          {/* Article 6 */}
          <section>
            <SectionHeading>第6条（個人情報の第三者提供）</SectionHeading>
          ...
          {/* Article 7 */}
          <section>
            <SectionHeading>第7条（安全管理措置）</SectionHeading>
            <p className="text-base font-light text-slate-600 leading-relaxed">
          ...
          {/* Article 8 */}
          <section>
            <SectionHeading>第8条（お問い合わせ窓口）</SectionHeading>
            <p className="text-base font-light text-slate-600 leading-relaxed">
